...
export default function AgentsPage() {
    const InfoCard = (
        <div className="p-4 md:p-8 rounded bg-[#25252d] w-full max-h-[85%] overflow-hidden">
            <h1 className="text-3xl md:text-4xl mb-4">▲ Next.js + LangChain.js Structured Output 🦜🔗</h1>
            <ul>
                <li className="text-l">
                    🧱
                    <span className="ml-2">
                ...
                <li>
                    ☎️
                    <span className="ml-2">
                        The chain formats the input schema and passes it into an OpenAI Functions model, then parses the
                        output.
                    </span>
                </li>
                ...
                <li className="hidden text-l md:block">
                    📊
                    <span className="ml-2">
                        By default, the chain returns an object with <code>tone</code>, <code>word_count</code>,{" "}
                        <code>entity</code>, <code>chat_response</code>, and an optional <code>final_punctuation</code>,
